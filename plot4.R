...
plotdataset[, dateTime := as.POSIXct(paste(Date, Time), format = "%d/%m/%Y %H:%M:%S")]

# Filter Dates for 2007-02-01 and 2007-02-02
plotdataset <- plotdataset[(dateTime >= "2007-02-01") & (dateTime < "2007-02-03")]
...
# Plot 1
plot(plotdataset[, dateTime], plotdataset[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(plotdataset[, dateTime],plotdataset[, Voltage], type="l", xlab="datetime", ylab="Voltage")

# Plot 3
plot(plotdataset[, dateTime], plotdataset[, Sub_metering_1], type="l", xlab="", ylab="Energy sub metering")
